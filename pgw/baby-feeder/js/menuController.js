var MenuCtrl = function($scope, $ionicModal, $ionicPopup, $ionicSideMenuDelegate, $filter) {
  ...
  $scope.share = function() {
    ...
    if (window.plugins && window.plugins.socialsharing) {
      window.plugins.socialsharing.share("Copy-paste this code into the 'Connect Devices' -> 'Enter code' menu in Ionic Baby Feeding: \n" + userId, "Ionic Baby Feeding share code");
    }
  }

  $scope.feedback = function() {
    if (window.plugins && window.plugins.socialsharing) {
      window.plugins.socialsharing.shareViaEmail('' /*no message*/, 'Just a note', ['ionic_baby_feeding@kvrgic.se']);
    }
  }
