...
AdMob.prototype.createBannerView =
    function (options, successCallback, failureCallback) {
        var defaults = {
            'publisherId': 'pub-3567837417921099',
            'adSize': 'BANNER',
            'positionAtTop': false
        };
        ...
        cordova.exec(
            ...
            failureCallback,
            'AdMobPlugin',
            'createBannerView', [defaults['publisherId'], defaults['adSize'], defaults['positionAtTop']]
        );
    };
...
AdMob.prototype.requestAd =
    function (options, successCallback, failureCallback) {
        ...
        cordova.exec(
            ...
            failureCallback,
            'AdMobPlugin',
            'requestAd', [defaults['isTesting'], defaults['extras']]
        );
    };


AdMob.prototype.removeBannerView = function (successCallback, failureCallback) {
    cordova.exec(
        successCallback,
        failureCallback,
        'AdMobPlugin',
