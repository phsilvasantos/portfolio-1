function initializePushCallbacks() {
  ...
  window.pushNotifications.registerEvent('announcement', this, function(notificationData) {
    ...
    query.first().then(function(announcement) {
      ...
      openAnnouncement(announcement, announcement.get('for'), window.pushNotifications.state());
