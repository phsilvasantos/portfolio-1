...
(function ($, _, undefined) {
  ...
  var MentionsInput = function (settings) {
    ...
    function initAutocomplete() {
      ...
      //@wang - elmAutocompleteList.delegate('li', 'mousedown', onAutoCompleteItemClick); //Delegate the event
      ...
      switch (e.keyCode) {
        ...
        case KEY.TAB:
          if (elmActiveAutoCompleteItem && elmActiveAutoCompleteItem.length) { //If the elmActiveAutoCompleteItem exists
            //@wang - elmActiveAutoCompleteItem.trigger('mousedown'); //Calls the mousedown event
            elmActiveAutoCompleteItem.trigger('click'); //Calls the mousedown event
            return false;
          }
